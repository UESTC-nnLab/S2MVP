...
def parse_args():
    ...
    parser.add_argument(
        '--inputs', type=str, default='/home/public/DAUB/images/test/data20/10.bmp', help='Input image file or folder path.') #/home/public/ITSDT/images/84/35.bmp
    parser.add_argument(
        '--model',
        type=str,
        default='/home/dww/OD/MixPL/projects/MixPL/myconfig/mixpl_pgsl_itsdt.py',
        help='Config or checkpoint .pth file or the model name '
        'and alias defined in metafile. The model configuration '
        'file will try to read from .pth if the parameter is '
        'a .pth weights file.')
    parser.add_argument('--weights', default='/home/dww/OD/MixPL/work_dirs/mixpl_fcos_r50-caffe_fpn_180k_daub-s1-p10/DAUB/0.9571wnolocal/best_student_coco_bbox_mAP_50_iter_5500.pth', help='Checkpoint file')
    parser.add_argument(
        '--out-dir',
        type=str,
        default='outputs',
